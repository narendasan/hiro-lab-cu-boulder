...
///
/// ```typst
/// #title-slide(title: "Override Title", logo: image("../assets/hiro.svg", width: 60%))
/// ```
///
      ...
      block(
        ...
        grid(
          ...
          grid.cell(
            ...
            inset: (bottom: 0em),
            [
              #set text(size: .65em, fill: self.colors.white.transparentize(25%))
...
/// ```typst
/// #hero(
/// image("../assets/hiro.svg", height: 70%),
/// title: "Hero",
/// subtitle: "Subtitle",
/// )
/// ```
  ...
  show: touying-slides.with(
    ...
    config-methods(
      ...
      init: (self: none, body) => {
        ...
        show heading.where(level: 1): set text(size: settings.HEADER-SIZE, weight: "bold")
        show heading.where(level: 2): set block(below: 1.5em)
        // color links
        show link: it => text(
          link-color,
